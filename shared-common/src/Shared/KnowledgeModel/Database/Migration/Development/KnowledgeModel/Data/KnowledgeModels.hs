module Shared.KnowledgeModel.Database.Migration.Development.KnowledgeModel.Data.KnowledgeModels where
...
km1 =
  KnowledgeModel
    ...
    , integrationUuids = [repositoryApi.uuid, orcidPluginIntegration.uuid]
    , metricUuids =
    ...
    , entities =
        KnowledgeModelEntities
          ...
          , integrations = toMap [repositoryApi', orcidPluginIntegration']
...
km1Edited =
  KnowledgeModel
    ...
    , integrationUuids = [orcidPluginIntegration.uuid, repositoryApi.uuid]
    , metricUuids =
        [metricF.uuid, metricA.uuid, metricI.uuid, metricR.uuid, metricG.uuid, metricO.uuid]
    , phaseUuids = [phase1.uuid, phase2.uuid, phase3.uuid]
