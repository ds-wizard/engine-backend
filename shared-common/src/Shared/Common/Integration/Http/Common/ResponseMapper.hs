module Shared.Common.Integration.Http.Common.ResponseMapper (
...
extractResponseBody response =
  case eitherDecode . responseBody $ response of
    ...
    Left error -> Left . GeneralServerError $ _ERROR_INTEGRATION_COMMON__UNABLE_TO_DESERIALIZE_RESPONSE_BODY error
...
extractNestedField (k : ks) (Object obj) =
  case KM.lookup (fromString k) obj of
    ...
    Nothing -> Left . GeneralServerError $ _ERROR_INTEGRATION_COMMON__UNABLE_TO_EXTRACT_NESTED_FIELDS (k : ks)
extractNestedField keys _ = Left . GeneralServerError $ _ERROR_INTEGRATION_COMMON__UNABLE_TO_EXTRACT_NESTED_FIELDS keys
...
extractNestedStringField (k : ks) (Object obj) =
  case KM.lookup (fromString k) obj of
    ...
    Nothing -> Left . GeneralServerError $ _ERROR_INTEGRATION_COMMON__UNABLE_TO_EXTRACT_NESTED_FIELDS (k : ks)
extractNestedStringField keys _ = Left . GeneralServerError $ _ERROR_INTEGRATION_COMMON__UNABLE_TO_EXTRACT_NESTED_FIELDS keys
...
extractStringField fieldName (Object obj) =
  case KM.lookup (fromString fieldName) obj of
    ...
    _ -> Left . GeneralServerError $ _ERROR_INTEGRATION_COMMON__UNABLE_TO_EXTRACT_STRING_FIELD fieldName
extractStringField fieldName _ = Left . GeneralServerError $ _ERROR_INTEGRATION_COMMON__UNABLE_TO_EXTRACT_STRING_FIELD fieldName
