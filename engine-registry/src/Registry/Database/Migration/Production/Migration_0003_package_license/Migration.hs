module Registry.Database.Migration.Production.Migration_0003_package_license.Migration
  ( definition
  ) where
...
meta = MigrationMeta {mmNumber = 3, mmName = "Package License", mmDescription = "Add license field to packages"}
