...
a_km1_iop =
  AddIntegrationEvent
    ...
    , _addIntegrationEventResponseExampleJson = ontologyPortal ^. responseExampleJson
...
a_km1_ibp =
  AddIntegrationEvent
    ...
    , _addIntegrationEventResponseExampleJson = bioPortal ^. responseExampleJson
...
e_km1_iop =
  EditIntegrationEvent
    ...
    , _editIntegrationEventResponseExampleJson = ChangedValue $ ontologyPortalEdited ^. responseExampleJson
