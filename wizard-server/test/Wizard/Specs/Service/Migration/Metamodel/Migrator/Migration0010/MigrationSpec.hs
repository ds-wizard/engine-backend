module Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0010.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0010.MigrationFixtures as Fixtures
