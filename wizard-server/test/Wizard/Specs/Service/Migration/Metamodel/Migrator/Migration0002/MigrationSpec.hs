module Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0002.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0002.MigrationFixtures as Fixtures
