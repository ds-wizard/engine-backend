module Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0009.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0009.MigrationFixtures as Fixtures
