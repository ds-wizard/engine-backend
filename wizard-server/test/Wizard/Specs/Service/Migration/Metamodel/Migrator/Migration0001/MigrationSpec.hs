module Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0001.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0001.MigrationFixtures as Fixtures
