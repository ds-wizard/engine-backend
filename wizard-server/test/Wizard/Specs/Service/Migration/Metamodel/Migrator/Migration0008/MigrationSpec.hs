module Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0008.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0008.MigrationFixtures as Fixtures
