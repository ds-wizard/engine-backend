module Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0014.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0014.MigrationFixtures as Fixtures
