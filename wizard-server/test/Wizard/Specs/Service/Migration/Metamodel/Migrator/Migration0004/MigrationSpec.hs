module Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0004.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0004.MigrationFixtures as Fixtures
