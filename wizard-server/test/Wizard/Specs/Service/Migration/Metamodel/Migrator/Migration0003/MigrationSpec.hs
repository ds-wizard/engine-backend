module Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0003.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.Migration.Metamodel.Migrator.Migration0003.MigrationFixtures as Fixtures
