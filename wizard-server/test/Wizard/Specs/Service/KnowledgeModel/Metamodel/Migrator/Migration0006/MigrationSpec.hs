module Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0006.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0006.MigrationFixtures as Fixtures
