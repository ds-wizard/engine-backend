module Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0003.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0003.MigrationFixtures as Fixtures
