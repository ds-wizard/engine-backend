module Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0002.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0002.MigrationFixtures as Fixtures
