module Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0005.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0005.MigrationFixtures as Fixtures
