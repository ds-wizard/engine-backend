module Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0010.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0010.MigrationFixtures as Fixtures
