module Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0011.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0011.MigrationFixtures as Fixtures
