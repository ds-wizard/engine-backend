module Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0001.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0001.MigrationFixtures as Fixtures
