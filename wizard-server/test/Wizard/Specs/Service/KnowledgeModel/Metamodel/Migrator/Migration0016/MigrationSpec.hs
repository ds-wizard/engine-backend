module Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0016.MigrationSpec (
  spec,
) where
...
import Wizard.Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0016.MigrationFixtures as Fixtures
