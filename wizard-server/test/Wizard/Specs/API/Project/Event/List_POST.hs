module Wizard.Specs.API.Project.Event.List_POST (
  list_POST,
) where
...
test_403 appContext = do
  create_test_403 "HTTP 403 FORBIDDEN (Non-Owner, Private)" appContext project1 project1Events [reqNonAdminAuthHeader] (_ERROR_VALIDATION__FORBIDDEN "Edit Project")
  create_test_403 "HTTP 403 FORBIDDEN (Non-Owner, VisibleView)" appContext project2 project2Events [reqNonAdminAuthHeader] (_ERROR_VALIDATION__FORBIDDEN "Edit Project")
  create_test_403 "HTTP 403 FORBIDDEN (Commenter)" appContext (project13 {visibility = PrivateProjectVisibility}) project13Events [reqNonAdminAuthHeader] (_ERROR_VALIDATION__FORBIDDEN "Edit Project")
  create_test_403 "HTTP 403 FORBIDDEN (Non-Commenter, VisibleComment)" appContext project13 project13Events [reqIsaacAuthTokenHeader] (_ERROR_VALIDATION__FORBIDDEN "Edit Project")
  create_test_403 "HTTP 403 FORBIDDEN (Anonymous, VisibleComment, AnyoneWithLinkComment)" appContext (project13 {sharing = AnyoneWithLinkCommentProjectSharing}) project13Events [] _ERROR_SERVICE_USER__MISSING_USER
  create_test_403 "HTTP 403 FORBIDDEN (Anonymous, VisibleView, Sharing)" appContext project7 project7Events [] _ERROR_SERVICE_USER__MISSING_USER
  create_test_403 "HTTP 403 FORBIDDEN (Anonymous, VisibleView)" appContext project2 project2Events [] _ERROR_SERVICE_USER__MISSING_USER
  create_test_403 "HTTP 403 FORBIDDEN (Anonymous, Public)" appContext project3 project3Events [] _ERROR_SERVICE_USER__MISSING_USER
