module Wizard.Specs.API.DocumentTemplateDraft.Detail_DELETE (
  detail_DELETE,
) where
...
create_test_204 title appContext reqAuthHeader =
  it title $
    ...
    do
      ...
      assertCountInDB findDrafts appContext 0
...
-- ----------------------------------------------------
-- ----------------------------------------------------
test_403 appContext = createNoPermissionTest appContext reqMethod reqUrl [reqCtHeader] reqBody "DocumentTemplateEditorsUseRolePermission"
