...
findTenantConfigSubmission = do
  ...
  findTenantConfigSubmissionByTenantUuid tenantUuid

findTenantConfigSubmissionByTenantUuid :: U.UUID -> AppContextM TenantConfigSubmission
findTenantConfigSubmissionByTenantUuid tenantUuid = do
