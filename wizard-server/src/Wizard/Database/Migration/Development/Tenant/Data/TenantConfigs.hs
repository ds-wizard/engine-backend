...
defaultKnowledgeModelPublic =
  TenantConfigKnowledgeModelPublic
    ...
    , packages = fmap (\p -> fromKnowledgeModelPublicPackagePatternChangeDTO p defaultTenant.uuid (dt' 2018 1 20) (dt' 2018 1 20)) defaultKnowledgeModelPublicChangeDto.packages
    }
