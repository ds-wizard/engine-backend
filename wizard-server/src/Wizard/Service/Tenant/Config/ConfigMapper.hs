...
fromKnowledgeModelChangeDTO dto@TenantConfigKnowledgeModelChangeDTO {..} tenantUuid createdAt updatedAt =
  let packages = fmap (\f -> fromKnowledgeModelPublicPackagePatternChangeDTO f tenantUuid createdAt updatedAt) dto.public.packages
      public = TenantConfigKnowledgeModelPublic {enabled = dto.public.enabled, packages = packages}
   in TenantConfigKnowledgeModel {..}

fromKnowledgeModelPublicPackagePatternChangeDTO :: PackagePattern -> U.UUID -> UTCTime -> UTCTime -> TenantConfigKnowledgeModelPublicPackagePattern
fromKnowledgeModelPublicPackagePatternChangeDTO PackagePattern {..} tenantUuid createdAt updatedAt = TenantConfigKnowledgeModelPublicPackagePattern {..}
