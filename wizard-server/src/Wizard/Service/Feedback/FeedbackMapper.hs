...
toDTO serverConfig tcProject f =
  FeedbackDTO
    ...
    , knowledgeModelPackageUuid = f.knowledgeModelPackageUuid
    , title = f.title
    , content = f.content
...
fromCreateDTO dto fUuid issueId tenantUuid now =
  Feedback
    ...
    , knowledgeModelPackageUuid = dto.knowledgeModelPackageUuid
    , title = dto.title
    , content = dto.content
...
fromSimpleIssue feedback simpleIssue now =
  Feedback
    ...
    , knowledgeModelPackageUuid = feedback.knowledgeModelPackageUuid
