module Wizard.Database.Migration.Production.Migration_0005_levels_init.Migration
  ( definition
  ) where
...
import Wizard.Database.Migration.Production.Migration_0005_levels_init.Data.Levels
