module Wizard.Database.Migration.Production.Migration_0009_book_references_markdown.Migration
  ( definition
  ) where
...
import Wizard.Database.Migration.Production.Migration_0009_book_references_markdown.Data.BookReferences
