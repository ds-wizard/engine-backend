module Wizard.Database.Migration.Production.Migration_0001_organization_init.Migration
  ( definition
  ) where
...
import Wizard.Database.Migration.Production.Migration_0001_organization_init.Data.Organizations
