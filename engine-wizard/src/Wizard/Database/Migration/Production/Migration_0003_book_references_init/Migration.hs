module Wizard.Database.Migration.Production.Migration_0003_book_references_init.Migration
  ( definition
  ) where
...
import Wizard.Database.Migration.Production.Migration_0003_book_references_init.Data.BookReferences
