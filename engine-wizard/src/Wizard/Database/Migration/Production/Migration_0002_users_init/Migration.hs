module Wizard.Database.Migration.Production.Migration_0002_users_init.Migration
  ( definition
  ) where
...
import Wizard.Database.Migration.Production.Migration_0002_users_init.Data.Users
