module Wizard.Database.Migration.Development.KnowledgeModel.Data.Questions where
...
q4_it1_question5Plain =
  ListQuestion
    ...
    , _listQuestionRequiredLevel = q4_it1_question5 ^. requiredLevel
...
question9 =
  IntegrationQuestion
    ...
    , _integrationQuestionRequiredLevel = Just 1
