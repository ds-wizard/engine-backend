module Wizard.Specs.API.Questionnaire.Detail_Labels_GET
  ( detail_labels_GET
  ) where
...
-- ------------------------------------------------------------------------
-- GET /questionnaires/{qtnUuid}/labels
-- ------------------------------------------------------------------------
detail_labels_GET :: AppContext -> SpecWith ((), Application)
detail_labels_GET appContext =
  describe "GET /questionnaires/{qtnUuid}/labels" $ do
    test_200 appContext
    test_403 appContext
    test_404 appContext
...
reqUrlT qtnUuid = BS.pack $ "/questionnaires/" ++ U.toString qtnUuid ++ "/labels"
...
create_test_200 title appContext qtn qtnCtn authHeader =
  it title $
   ...
   do
    ...
    let expDto = toLabelListDTO (qtnCtn ^. labels)
...
test_404 appContext =
  createNotFoundTest'
    reqMethod
    "/questionnaires/f08ead5f-746d-411b-aee6-77ea3d24016a/labels"
