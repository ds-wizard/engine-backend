module Wizard.Metamodel.Event.Version0010.Common where
...
toSumJSON' typeFieldName dto =
  case genericToJSON (defaultOptions {sumEncoding = UntaggedValue}) dto of
    Object o ->
      Object $
      HashMap.union o (HashMap.fromList [(typeFieldName, String . T.pack . stripDTOSuffix . constructorName $ dto)])
...
simpleToJSON'' fieldPrefix additionalData dto =
  case simpleToJSON fieldPrefix dto of
    Object o -> Object $ HashMap.union o (HashMap.fromList additionalData)
