...
import qualified Wizard.Metamodel.Event.Version7.Common as V7
import qualified Wizard.Metamodel.Event.Version7.KnowledgeModel as V7
import qualified Wizard.Metamodel.Event.Version7.Question as V7
