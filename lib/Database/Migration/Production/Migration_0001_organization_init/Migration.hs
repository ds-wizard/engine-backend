module Database.Migration.Production.Migration_0001_organization_init.Migration
  ( definition
  ) where
...
import Database.Migration.Production.Migration_0001_organization_init.Data.Organizations
