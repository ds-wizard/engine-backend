module Database.Migration.Production.Migration_0011_update_data_steward_perms.Migration
  ( definition
  ) where
...
meta =
  MigrationMeta
  {mmNumber = 11, mmName = "Update DATASTEWARD Perms", mmDescription = "Add 'PM_WRITE_PERM' to DATASTEWARD permissions"}
