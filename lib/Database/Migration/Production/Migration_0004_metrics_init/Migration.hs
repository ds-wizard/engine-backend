module Database.Migration.Production.Migration_0004_metrics_init.Migration
  ( definition
  ) where
...
import Database.Migration.Production.Migration_0004_metrics_init.Data.Metrics
