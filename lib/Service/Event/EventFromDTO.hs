...
instance EventFromDTO AddKnowledgeModelEventDTO where
  fromDTO dto =
    AddKnowledgeModelEvent'
      ...
      , _addKnowledgeModelEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO EditKnowledgeModelEventDTO where
  fromDTO dto =
    EditKnowledgeModelEvent'
      ...
      , _editKnowledgeModelEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO AddChapterEventDTO where
  fromDTO dto =
    AddChapterEvent'
      ...
      , _addChapterEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO EditChapterEventDTO where
  fromDTO dto =
    EditChapterEvent'
      ...
      , _editChapterEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO DeleteChapterEventDTO where
  fromDTO dto =
    DeleteChapterEvent'
      ...
      , _deleteChapterEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO AddQuestionEventDTO where
  fromDTO (AddOptionsQuestionEventDTO' dto) =
    ...
    , _addOptionsQuestionEventPath = fromPathDTO $ dto ^. path
  ...
  fromDTO (AddListQuestionEventDTO' dto) =
    ...
    , _addListQuestionEventPath = fromPathDTO $ dto ^. path
  ...
  fromDTO (AddValueQuestionEventDTO' dto) =
    ...
    , _addValueQuestionEventPath = fromPathDTO $ dto ^. path
  ...
  fromDTO (AddIntegrationQuestionEventDTO' dto) =
    ...
    , _addIntegrationQuestionEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO EditQuestionEventDTO where
  fromDTO (EditOptionsQuestionEventDTO' dto) =
    ...
    , _editOptionsQuestionEventPath = fromPathDTO $ dto ^. path
  ...
  fromDTO (EditListQuestionEventDTO' dto) =
    ...
    , _editListQuestionEventPath = fromPathDTO $ dto ^. path
  ...
  fromDTO (EditValueQuestionEventDTO' dto) =
    ...
    , _editValueQuestionEventPath = fromPathDTO $ dto ^. path
  ...
  fromDTO (EditIntegrationQuestionEventDTO' dto) =
    ...
    , _editIntegrationQuestionEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO DeleteQuestionEventDTO where
  fromDTO dto =
    DeleteQuestionEvent'
      ...
      , _deleteQuestionEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO AddAnswerEventDTO where
  fromDTO dto =
    AddAnswerEvent'
      ...
      , _addAnswerEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO EditAnswerEventDTO where
  fromDTO dto =
    EditAnswerEvent'
      ...
      , _editAnswerEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO DeleteAnswerEventDTO where
  fromDTO dto =
    DeleteAnswerEvent'
      ...
      , _deleteAnswerEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO AddExpertEventDTO where
  fromDTO dto =
    AddExpertEvent'
      ...
      , _addExpertEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO EditExpertEventDTO where
  fromDTO dto =
    EditExpertEvent'
      ...
      , _editExpertEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO DeleteExpertEventDTO where
  fromDTO dto =
    DeleteExpertEvent'
      ...
      , _deleteExpertEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO AddReferenceEventDTO where
  fromDTO (AddResourcePageReferenceEventDTO' event) =
    ...
    , _addResourcePageReferenceEventPath = fromPathDTO $ event ^. path
  ...
  fromDTO (AddURLReferenceEventDTO' event) =
    ...
    , _addURLReferenceEventPath = fromPathDTO $ event ^. path
  ...
  fromDTO (AddCrossReferenceEventDTO' event) =
    ...
    , _addCrossReferenceEventPath = fromPathDTO $ event ^. path
...
instance EventFromDTO EditReferenceEventDTO where
  fromDTO (EditResourcePageReferenceEventDTO' event) =
    ...
    , _editResourcePageReferenceEventPath = fromPathDTO $ event ^. path
  ...
  fromDTO (EditURLReferenceEventDTO' event) =
    ...
    , _editURLReferenceEventPath = fromPathDTO $ event ^. path
  ...
  fromDTO (EditCrossReferenceEventDTO' event) =
    ...
    , _editCrossReferenceEventPath = fromPathDTO $ event ^. path
...
instance EventFromDTO DeleteReferenceEventDTO where
  fromDTO event =
    DeleteReferenceEvent'
      ...
      , _deleteReferenceEventPath = fromPathDTO $ event ^. path
...
instance EventFromDTO AddTagEventDTO where
  fromDTO dto =
    AddTagEvent'
      ...
      , _addTagEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO EditTagEventDTO where
  fromDTO dto =
    EditTagEvent'
      ...
      , _editTagEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO DeleteTagEventDTO where
  fromDTO dto =
    DeleteTagEvent'
      ...
      , _deleteTagEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO AddIntegrationEventDTO where
  fromDTO dto =
    AddIntegrationEvent'
      ...
      , _addIntegrationEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO EditIntegrationEventDTO where
  fromDTO dto =
    EditIntegrationEvent'
      ...
      , _editIntegrationEventPath = fromPathDTO $ dto ^. path
...
instance EventFromDTO DeleteIntegrationEventDTO where
  fromDTO dto =
    DeleteIntegrationEvent'
      ...
      , _deleteIntegrationEventPath = fromPathDTO $ dto ^. path
