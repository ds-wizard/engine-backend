module Service.Migration.KnowledgeModel.Migrator.Migrator where
...
import Service.Migration.KnowledgeModel.Migrator.CleanerMethod
import Service.Migration.KnowledgeModel.Migrator.CorrectorMethod
