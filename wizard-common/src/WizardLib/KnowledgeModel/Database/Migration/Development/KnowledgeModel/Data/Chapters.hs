module WizardLib.KnowledgeModel.Database.Migration.Development.KnowledgeModel.Data.Chapters (
  chapter1,
  chapter1Edited,
...
chapter3 =
  Chapter
    ...
    , text = Just ""
    , annotations = []
    , questionUuids = [question9.uuid, question10.uuid, question11.uuid, question12.uuid, question13.uuid, question14.uuid, question15.uuid]
    }
