module WizardLib.DocumentTemplate.Database.Migration.Development.DocumentTemplate.Data.DocumentTemplateFiles where
...
fileDefaultHtmlEdited :: DocumentTemplateFile
