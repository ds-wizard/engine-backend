 ...
 describe "Applicator" $ do
   ...
   describe "Apply:  Question Events" $ do
     ...
     it "Apply:  DeleteQuestionEvent" $ do
       ...
       let computed = migrate initKM [DeleteQuestionEvent' d_km1_ch1_q3]
       let expected = km1
       computed `shouldBe` expected
   -- ---------------
   describe "Apply:  Answer Events" $ do
     it "Apply:  AddAnswerEvent" $ do
       let computed = migrate km1 [AddAnswerEvent' a_km1_ch1_q2_aMaybe]
     ...
     it "Apply:  EditAnswerEvent" $ do
       let computed = migrate km1 [EditAnswerEvent' e_km1_ch1_q2_aYes1]
     ...
     it "Apply:  DeleteAnswerEvent" $ do
       let computed = migrate km1 [DeleteAnswerEvent' d_km1_ch1_q2_aYes1]
   ...
   describe "Apply:  Follow-Up Question Events" $ do
     it "Apply:  AddFollowUpQuestionEvent" $ do
       ...
       let computed = migrate km1 [AddFollowUpQuestionEvent' event]
     ...
     it "Apply:  EditFollowUpQuestionEvent" $ do
       ...
       let computed = migrate km1 [EditFollowUpQuestionEvent' event]
     ...
     it "Apply:  DeleteFollowUpQuestionEvent" $ do
       ...
       let computed = migrate km1 [DeleteFollowUpQuestionEvent' event]
   ...
   describe "Apply:  Expert Events" $ do
     it "Apply:  AddExpertEvent" $ do
       let computed = migrate km1 [AddExpertEvent' a_km1_ch1_q2_eJohn]
     ...
     it "Apply:  EditExpertEvent" $ do
       let computed = migrate km1 [EditExpertEvent' e_km1_ch1_q2_eDarth]
     ...
     it "Apply:  DeleteExpertEvent" $ do
       let computed = migrate km1 [DeleteExpertEvent' d_km1_ch1_q2_eLuke]
   ...
   describe "Apply:  Reference Events" $ do
     it "Apply:  AddReferenceEvent" $ do
       let computed = migrate km1 [AddReferenceEvent' a_km1_ch1_q2_rCh3]
     ...
     it "Apply:  EditReferenceEvent" $ do
       let computed = migrate km1 [EditReferenceEvent' e_km1_ch1_q2_rCh1]
     ...
     it "Apply:  DeleteReferenceEvent" $ do
       let computed = migrate km1 [DeleteReferenceEvent' d_km1_ch1_q2_rCh2]
