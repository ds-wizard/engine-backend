...
chooseEventDeserializator doc = do
  ...
  case eventType of
    "AddKnowledgeModelEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe AddKnowledgeModelEvent)
    "EditKnowledgeModelEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe EditKnowledgeModelEvent)
    "AddChapterEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe AddChapterEvent)
    "EditChapterEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe EditChapterEvent)
    "DeleteChapterEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe DeleteChapterEvent)
    "AddQuestionEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe AddQuestionEvent)
    "EditQuestionEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe EditQuestionEvent)
    "DeleteQuestionEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe DeleteQuestionEvent)
    "AddAnswerEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe AddAnswerEvent)
    "EditAnswerEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe EditAnswerEvent)
    "DeleteAnswerEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe DeleteAnswerEvent)
    "AddExpertEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe AddExpertEvent)
    "EditExpertEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe EditExpertEvent)
    "DeleteExpertEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe DeleteExpertEvent)
    "AddReferenceEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe AddReferenceEvent)
    "EditReferenceEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe EditReferenceEvent)
    "DeleteReferenceEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe DeleteReferenceEvent)
    "AddFollowUpQuestionEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe AddFollowUpQuestionEvent)
    "EditFollowUpQuestionEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe EditFollowUpQuestionEvent)
    "DeleteFollowUpQuestionEvent" -> Just . MkEvent . fromJust $ (fromBSON doc :: Maybe DeleteFollowUpQuestionEvent)
