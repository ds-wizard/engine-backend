...
createKnowledgeModelContainer :: Context -> KnowledgeModelContainerDTO -> IO KnowledgeModelContainerDTO
createKnowledgeModelContainer context kmcDto = do
  let kmc = fromDTO kmcDto
  insertKnowledgeModelContainer context kmc
  return $ toDTO kmc

getKnowledgeModelContainerById :: Context -> String -> IO (Maybe KnowledgeModelContainerDTO)
...
modifyKnowledgeModelContainer :: Context -> String -> KnowledgeModelContainerDTO -> IO (Maybe KnowledgeModelContainerDTO)
